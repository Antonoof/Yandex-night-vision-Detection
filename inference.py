...
from src.model import configure_nms_time_limit
...
def main(config):
    ...
    val_records = preprocessor.prepare_split(val_records, "val")
    transform_info = {
        "enabled": preprocessor.active,
        "cache_namespace": preprocessor.cache_namespace,
        "apply_to": sorted(preprocessor.apply_to),
    }
    del preprocessor
